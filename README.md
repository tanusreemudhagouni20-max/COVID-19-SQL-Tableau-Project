[1(a) covid 19 DA sql query tanu.sql](https://github.com/user-attachments/files/26030043/1.a.covid.19.DA.sql.query.tanu.sql)[1(a) covid 19 DA sql query tanu.sql](https://github.com/user-attachments/files/26029779/1.a.covid.19.DA.sql.query.tanu.sql)[1(a) covid 19 DA sql query tanu.sql](https://github.com/user-attachments/files/26029716/1.a.covid.19.DA.sql.query.tanu.sql)# COVID-19-SQL-Tableau-Project
...
The project shows how data analysis and visualization techniques can help transform raw data into insights that support data-driven understanding of global events.
